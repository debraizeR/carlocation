    ...
    <div data-aos="fade-up" id="register" class="card shadow mb-5 col-7 text-left card-center">
        <ul class="list-group list-group-flush">
            <div class="text-center">
                ...
                <br>
                <br>
                Ce site est édité par la société <span class="wtLegalMentionsPropName">CarLocation</span>.
                <br>
                Siège social : <span class="wtLegalMentionsPropName">CarLocation</span>, 16
                Boulevard Amiral Mouchez, 76600
                Le Havre, France.s<br>
                Capital social : XXXXX euros<br>
                Téléphone : +33 (0)2 35 24 12 45<br>
                <br>
                Responsable de la rédaction : DEBRAIZE Raphael  et COURCELLE LAURENT<br>
                <br>
                Développement, hébergement : VISUAL STUDIO CODE <br><br>
                ...
                société
                <span class="wtLegalMentionsPropName">CarLocation</span>.<br>
                <br>
                Elles ne font l'objet d'aucune cession à des tiers. <span class="wtLegalMentionsPropName">CarLocationT</span> traite les informations qui vous
                concernent
                avec
                ...
                propriété
                de
                la société CarLocation, il est protégé par les lois en vigueur de la législation française sur la propriété
                intellectuelle.<br>
                <br>
                ...
                utiliser
                ce
                site. CarLocation ne saurait être tenu responsable des éléments en dehors de son contrôle et des dommages
                qui
                ...
                <br>
                <span class="wtLegalMentionsPropName">CarLocation</span> s'attache à transmettre des informations
                ...
                la
                responsabilité de CarLocation.<br>
                De même que la société <span class="wtLegalMentionsPropName">CarLocation</span> ne pourra en aucune façon
